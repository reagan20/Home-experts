<footer class="main-footer" style="text-align: center;">
    <strong>Copyright &copy; Day To Day Home Experts <?php echo date('Y'); ?>.</strong> All rights reserved. Designed by
    <a href="mailto:journalreagan@gmail.com" style="color: white;">journalreagan@gmail.com</a>
</footer>    </div><!-- ./wrapper -->
