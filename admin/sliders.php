...
if (@$_GET['act']=="delete") {
    $sql = "DELETE from sliders WHERE id='$x'";
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <a href="add_sliders" type="button" class="btn btn-success">Create New +</a>
            </div> </div><br/>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-condensed table-hover dataTables" id="dataTables-libraryList">
                        ...
                        <td>
                            <a class="btn btn-sm btn-info" href="edit_sliders?user_id=<?php echo $row['id'];?>">Update</a>
