...
$id = $_GET['user_id'];
if($id !=""){
   $mail=$conn->query("SELECT email FROM helpers_registration_details WHERE id='$id' LIMIT 1");
  ...
  <div class="panel-body">
     ...
     <form role="form" method="post" name="saveComposedMail" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <input required="required" name="receiver" type="email" value="<?php echo $m; ?>" class="form-control" placeholder="Enter Email Address">
      </div>
      <div class="form-group">
