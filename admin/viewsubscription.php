...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            View Subscription <a class="btn btn-sm btn-info" href="alert_subscribers">Send to Subscribers</a>
        </h1>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-condensed table-hover dataTables" id="dataTables-libraryList">
                        ...
                        <td><a class="btn btn-sm btn-danger" onclick="return confirm('Sure to delete? It will be deleted permanetly!')" href="?action=transview&id=<?php echo $row['id'];?>&act=delete">Delete</a> </td>
                        </tbody>
                        <?php
                        echo "</tr>";
                        }
